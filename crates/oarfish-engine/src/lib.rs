...
pub use config::{
    ...
    DEFAULT_FLAP_COOLDOWN_SECS, DEFAULT_MATTERS_NOW_THRESHOLD, DEFAULT_MAX_CONTEXT_ALARMS,
    DEFAULT_MAX_WINDOWS, DEFAULT_PENDING_CAPACITY, DEFAULT_RATE_MULTIPLE, DEFAULT_SILENCE_SECS,
    DEFAULT_WINDOW_COUNT_THRESHOLD, EngineConfig,
};
pub use context::{
